...
let ListC : string[] = ['Pakistan','Canada','China','Japan','Korea','England'];

console.log(ListC[6])   // this will show index array

console.log(ListC[4]) // this will not show index array
